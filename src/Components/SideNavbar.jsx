...
import { AiOutlineHome, AiOutlineDashboard, AiOutlineFileDone, AiOutlineSchedule, AiOutlineClose } from 'react-icons/ai';
    ...
    return (
        <>
            <div className='hamburger d-block d-lg-none'>
                {
                    display ? <AiOutlineClose size={30} onClick={handleDisplay} /> : <FiMenu size={30} onClick={handleDisplay} />
                }

            </div>
            {
                display ? <ResponsiveSideNav /> : null
            }
